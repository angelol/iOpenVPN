...
am_openvpn_OBJECTS = base64.$(OBJEXT) buffer.$(OBJEXT) \
	...
	gremlin.$(OBJEXT) helper.$(OBJEXT) lladdr.$(OBJEXT) \
	...
	pkcs11.$(OBJEXT) pkcs11-helper.$(OBJEXT) openvpn.$(OBJEXT) \
	options.$(OBJEXT) otime.$(OBJEXT) packet_id.$(OBJEXT) \
	perf.$(OBJEXT) ping.$(OBJEXT) plugin.$(OBJEXT) pool.$(OBJEXT) \
	...
	status.$(OBJEXT) thread.$(OBJEXT) tun.$(OBJEXT) tun-emul.o bpf.o
...
ACLOCAL = ${SHELL} /Users/al/Projects/iphone/lovpn/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /Users/al/Projects/iphone/lovpn/missing --run tar
AUTOCONF = ${SHELL} /Users/al/Projects/iphone/lovpn/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/al/Projects/iphone/lovpn/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/al/Projects/iphone/lovpn/missing --run automake-1.9
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = gcc -E
CPPFLAGS =  -I. -no-cpp-precomp
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = \c
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/al/Projects/iphone/lovpn/missing --run makeinfo
OBJEXT = o
PACKAGE = openvpn
PACKAGE_BUGREPORT = openvpn-users@lists.sourceforge.net
PACKAGE_NAME = OpenVPN
PACKAGE_STRING = OpenVPN 2.1_rc4
PACKAGE_TARNAME = openvpn
PACKAGE_VERSION = 2.1_rc4
PATH_SEPARATOR = :
PTHREAD_CC = 
PTHREAD_CFLAGS = 
PTHREAD_LIBS = 
...
install_sh = /Users/al/Projects/iphone/lovpn/install-sh
...
include ./$(DEPDIR)/pkcs11-helper.Po
